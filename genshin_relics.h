...
private slots:
	...
	void on_comboBox_5_currentIndexChanged(const QString &text);
...
private:
	...
	double total_attr;//单个圣遗物得分，以百分制为基准
	double total_attr_2;
	double addition_attr;//单个圣遗物副属性得分，以百分制为基准
	double addition_attr_2;
